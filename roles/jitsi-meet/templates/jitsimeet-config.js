...
{% endif %}
        ...
        // authdomain: '{{ meet_domain }}',

        // Call control component (Jigasi).
        // call_control: 'callcontrol.{{ meet_domain }}',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.{{ meet_domain }}',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.{{ meet_domain }}'
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: '//{{ meet_domain }}/http-bind',

    // Websocket URL
    // websocket: 'wss://{{ meet_domain }}/xmpp-websocket',
    ...
    // focusUserJid: 'focus@auth.{{ meet_domain }}',
...
{% endif %}
    ...
    //     // by default uses:
    //     // 'https://{{ meet_domain }}/static/oauth.html'
    //     redirectURI:
    //          'https://{{ meet_domain }}/subfolder/static/oauth.html'
    // },
...
{% if groups['jibris'] | length > 0 %}
    ...
    hiddenDomain: 'recorder.{{ meet_domain }}',
{% else %}
...
{% endif %}
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.{{ meet_domain }}',
